...
class EngineServer:
    def __init__(self, services: ServiceContainer, user_home: Path | str | None = None) -> None:
        ...
        self._dispatcher.register("computer.state.get", self._turns.computer_state)
        self._dispatcher.register("computer.grant.issue", self._turns.computer_grant_issue)
        self._dispatcher.register("computer.grant.revoke", self._turns.computer_grant_revoke)
